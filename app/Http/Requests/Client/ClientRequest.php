...
class ClientRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'email' => 'nullable|email|unique:clients,email,NULL,id,deleted_at,NULL',
            'company_name' => 'nullable|string',
            'guarantor_name' => 'nullable|string',
            'guarantor_dni' => 'nullable|numeric|unique:guarantors,dni,NULL,id,deleted_at,NULL',
        ...
        if ($this->isMethod('put')) {
            ...
            $rules = [
                ...
                'email' => 'nullable|email|unique:clients,email,' . $clientId . ',id,deleted_at,NULL',
