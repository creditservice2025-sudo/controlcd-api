...
class SellerConfigRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'max_credit_amount_new' => 'nullable|integer|min:0',
            'max_credit_amount_renewal' => 'nullable|integer|min:0',
            'renewal_min_quotas_paid' => 'nullable|integer|min:0',
            'max_credits_per_client' => 'nullable|integer|min:0',
