...
class SellerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules = [
            ...
            'commission_system_active' => 'nullable|boolean',
            'commission_utility_recon_madrid' => 'nullable|numeric',
            'commission_total_collection' => 'nullable|numeric',
            'commission_regrouping' => 'nullable|numeric',
            'commission_paid_credits' => 'nullable|numeric',
            'monthly_fixed_salary' => 'nullable|numeric',
            'pension_discount' => 'nullable|numeric',
